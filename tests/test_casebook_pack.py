"""Regression checks for the jobloom casebook."""
...
from casebook.harness import assert_expected, jobloom_summary
...
class CasebookTests(unittest.TestCase):
    ...
    def test_named_summary_alias(self) -> None:
        self.assertEqual(jobloom_summary(), assert_expected())
