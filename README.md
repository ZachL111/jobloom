...
jobloom is a Elixir project for backend services. It focuses on this technical goal: Schedule actor-style jobs with retry policy and queue inspection.
...
The core module exposes a small scoring API. Inputs are simple numeric signals: demand, capacity, latency, risk, and weight. The score uses a threshold of 153, risk penalty 7, latency penalty 2, and weight bonus 5. Tests exercise the public API against the fixture cases in `fixtures/cases.csv`.
